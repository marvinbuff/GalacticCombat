...
fun main() {
  val postitiveTests = listOf("203.202,23 EUR", "202,32 EUR", "0,23 CAN", "1.000,100", "23,22", "203.222.233.233,23", "$ 20,23", "-$ 233,23", "ABC -230.222,23", "23", "24,4444444444")
...
fun onlyMatchWithMoneyValue(line: String) {
  ...
  print("${doesMatch}Line: '$line' finds ${if (negated) "-" else ""}$finding")
  if (finding != null) {
